...
export const sendPasswordEmail = async (email, token) => {
  ...
  const mailOptions = {
    ...
    <p style="font-size: 16px; color: #555;">Para generar una nueva contraseña, haz clic en el siguiente botón:</p>
    <div style="text-align: center; font-size: 20px; margin: 20px 0;">
      <a href="http://localhost:5173/generar-password/${token}">Cambiar contraseña</a>
    </div>
